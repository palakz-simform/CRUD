...
function displayData(data) {
  ...
  data.length == 0 ? html =`<tr><td colspan="6"><h4 id="no-product">No Data Available! <br><br><button class="btn btn-success"><a href="/CRUD_Operation/">Add Data</a></button></h4></td></tr>` : 
(
    ...
    if(true){
      ...
      if (products.length > 0) {
       ...
       // clearFormData();  
        ...
        window.location.href="/CRUD_Operation/"
      }
    }
